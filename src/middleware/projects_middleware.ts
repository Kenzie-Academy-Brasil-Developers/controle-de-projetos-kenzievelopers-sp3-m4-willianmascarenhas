...
const verifyDevId = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
...
const verifyTecName = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
    let data: TTecnologieRequest = req.body

    if(req.route.path === `/projects/:id/technologies/:name` && req.method === "DELETE"){
      data ={
...
const verifyTecNameExists = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
  let data: TTecnologieRequest = req.body
